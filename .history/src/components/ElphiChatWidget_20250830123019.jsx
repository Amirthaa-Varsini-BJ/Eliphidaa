...
function ElphiChatWidget() {
  ...
  return (
    <div className="elphi-widget">
      {/* Floating Bot Button */}
    import robotImg from '../assets/robot.png'; // adjust the path
...
>
  ...
  <button
    ...
    title="Copy"
  >
    <img src="/assets/copy-icon.png" alt="Copy" style={{ width: 16, height: 16 }} />
  </button>
  {m.sender === 'user' && (
    <button
      className="icon-btn"
      ...
      title="Edit"
    >
      <img src="/assets/edit-icon.png" alt="Edit" style={{ width: 16, height: 16 }} />
    </button>
  )}
</div>
              </div>
